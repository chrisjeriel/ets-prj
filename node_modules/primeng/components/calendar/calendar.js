...
var ngx_mask = require("../../../ngx-mask/fesm5/ngx-mask");
...
var Calendar = /** @class */ (function () {
    function Calendar(el, renderer, cd) {
        this.fieldMask = "M0/d0/0000 M0:m0 SS";
        this.el = el;
    ...
    Calendar.prototype.ngOnInit = function () {
        if(this.showTime && this.timeOnly) {
            this.fieldMask = "M0:m0 SS";
        } else if(!this.showTime) {
            this.fieldMask = "M0/d0/0000";
        }
    ...
    Calendar.prototype.onUserInput = function (event) {
        ...
        // var val = event.target.value; --ORIGINAL
        var val = String(event.target.value).toUpperCase();
        try {
...
var CalendarModule = /** @class */ (function () {
    ...
    CalendarModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, button_1.ButtonModule, shared_1.SharedModule, ngx_mask.NgxMaskModule],
