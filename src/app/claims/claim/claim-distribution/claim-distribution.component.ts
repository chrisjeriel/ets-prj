...
export class ClaimDistributionComponent implements OnInit {
  ...
  poolDistPassData: any = {
  	tableData: [
  		new PoolDistribution('AFP',1,146341.46,199,0),
  		new PoolDistribution('Allied Bankers',1,146341.46,199,0),
  		new PoolDistribution('Alpha',1,146341.46,58,0),
      new PoolDistribution('AFP',1,146341.46,199,0),
      new PoolDistribution('Allied Bankers',1,146341.46,199,0),
      new PoolDistribution('Alpha',1,146341.46,58,0),
      new PoolDistribution('AFP',1,146341.46,199,0),
    ...
    pagination:false,
    pageStatus:false,
    total: ['Total','firstRetLine','firstRet','secRetLine','secRet'],
    tableOnly: true
  }	
