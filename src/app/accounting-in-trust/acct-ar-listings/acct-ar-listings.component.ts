...
export class AcctArListingsComponent implements OnInit {
  ...
  passData: any = {
    ...
    ['3','Charter Ping An',new Date('2018-10-3'),'Claim Recovery / Overpayment','Printed','Representing claim recovery payment for Claim No. CAR-2018-000001',100000],
    ...
    ['7','New India',new Date('2018-10-7'),'Claim Recovery / Overpayment','New','Representing claim recovery payment for Claim No. CAR-2018-000001',30000],
    ['8','BPI/MS INSURANCE CORPORATION',new Date('2018-10-7'),'Claim Recovery / Overpayment','Printed','Representing claim recovery payment for Claim No. CAR-2018-000001',10000],
