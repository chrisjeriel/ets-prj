...
@Component({
  selector: 'app-acse-close-open-dcb',
  templateUrl: './acse-close-open-dcb.component.html',
  styleUrls: ['./acse-close-open-dcb.component.css']
})
export class AcseCloseOpenDcbComponent implements OnInit {
  ...
  onClickView(){
    ...
    var sub$ = forkJoin(this.accountingService.getAcseDcbCollection(this.params.dcbYear,this.params.dcbNo),
                        this.accountingService.getAcseBankDetails(this.params.dcbYear,this.params.dcbNo)
