...
export class OrOthersComponent implements OnInit, OnDestroy {
  ...
  setSelectedData(data){
    ...
    if(selected[0].taxId !== undefined){ //set values to general taxes table
      ...
      for(var i = 0; i < selected.length; i++){
        ...
        this.passDataGenTax.tableData[this.passDataGenTax.tableData.length - 1].billId = 2;
      ...
      for(var i = 0; i < selected.length; i++){
        ...
        this.passDataWhTax.tableData[this.passDataWhTax.tableData.length - 1].billId = 2;
  ...
  save(cancelFlag?){
    ...
    for (var i = 0 ; this.passData.tableData.length > i; i++) {
      if(this.passData.tableData[i].edited && !this.passData.tableData[i].deleted){
          ...
          this.savedData[this.savedData.length-1].billId = 2; //2 for Others Transaction Type
