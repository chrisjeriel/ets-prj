...
export class UnderwritingService {
    ...
    getPolicyBatchPosting() {
        this.batchPosting = [
            new UnderwritingBatchPosting(10010, 10002, 'Dist. but not posted', 'EAR', 'EAR-2018-000002-021-0192-090', 'Retrocession','Battad Insurance', 'ACM Builders / Adfran Corporation', 'C-Siemens/PLDT','Cooling Towers','Brgy Silang, Naic Cavite','Php',8870000,131000,new Date(),new Date,new Date(), new Date(), new Date()),
            new UnderwritingBatchPosting(10010, 10002, 'Dist. but not posted', 'EAR', 'EAR-2018-000002-021-0192-090', 'Retrocession','Battad Insurance', 'ACM Builders / Adfran Corporation', 'C-Siemens/PLDT','Cooling Towers','Brgy Silang, Naic Cavite','Php',8870000,131000,new Date(),new Date,new Date(), new Date(), new Date()),
            new UnderwritingBatchPosting(10010, 10002, 'Dist. but not posted', 'EAR', 'EAR-2018-000002-021-0192-090', 'Retrocession','Battad Insurance', 'ACM Builders / Adfran Corporation', 'C-Siemens/PLDT','Cooling Towers','Brgy Silang, Naic Cavite','Php',8870000,131000,new Date(),new Date,new Date(), new Date(), new Date()),
            new UnderwritingBatchPosting(10010, 10002, 'Dist. but not posted', 'EAR', 'EAR-2018-000002-021-0192-090', 'Retrocession','Battad Insurance', 'ACM Builders / Adfran Corporation', 'C-Siemens/PLDT','Cooling Towers','Brgy Silang, Naic Cavite','Php',8870000,131000,new Date(),new Date,new Date(), new Date(), new Date()),
            new UnderwritingBatchPosting(10010, 10002, 'Dist. but not posted', 'EAR', 'EAR-2018-000002-021-0192-090', 'Retrocession','Battad Insurance', 'ACM Builders / Adfran Corporation', 'C-Siemens/PLDT','Cooling Towers','Brgy Silang, Naic Cavite','Php',8870000,131000,new Date(),new Date,new Date(), new Date(), new Date()),
