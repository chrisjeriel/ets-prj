...
export class QuotationService {
    ...
    getReadyForPrinting(){
        this.readyForPrinting = [
            new ReadyForPrint("CAR-2018-00088-00-99","Rose Lim","Direct","CAR Wet Risks","In Progress","Malayan","5K Builders","ABE International Corp","5K Builders & ABE International Corp"),
            new ReadyForPrint("CAR-2018-00088-00-78","Henry Tui","Retrocession","CAR Wet Risks","In Progress","FLT Primes","5K Builders","ABE International Corp","5K Builders & ABE International Corp"),
        ];
