...
@Component({
  selector: 'app-pol-distribution-cum',
  templateUrl: './pol-distribution-cum.component.html',
  styleUrls: ['./pol-distribution-cum.component.css']
})
export class PolDistributionCumComponent implements OnInit {
  ...
  retrievePolicyDistribution(){
    this.polService.getPolDistributionCum(this.params.policyId).subscribe((data: any)=>{
  ...
  retrievePoolDistribution(){
    ...
    this.polService.getPolPoolDistributionCum (this.polDistributionData.distNo,this.params.policyId ).subscribe((data:any)=>{
