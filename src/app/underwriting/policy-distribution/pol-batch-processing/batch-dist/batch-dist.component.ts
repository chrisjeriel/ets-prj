...
@Component({
  selector: 'app-batch-dist',
  templateUrl: './batch-dist.component.html',
  styleUrls: ['./batch-dist.component.css']
})
export class BatchDistComponent implements OnInit {
  ...
  retrievePolDistList(){
      this.searchParams.push({key:"statusArr",search:['U']})
