...
@Component({
  selector: 'app-edit-distribution-risk',
  templateUrl: './edit-distribution-risk.component.html',
  styleUrls: ['./edit-distribution-risk.component.css']
})
export class EditDistributionRiskComponent implements OnInit {
