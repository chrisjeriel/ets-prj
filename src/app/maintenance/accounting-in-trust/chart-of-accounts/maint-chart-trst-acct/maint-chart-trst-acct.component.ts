...
export class MaintChartTrstAcctComponent implements OnInit, OnDestroy {
  ...
  getRecords(printParams?){
    this.ms.getMtnAcitChartAcct(printParams).pipe(finalize(() => this.finalGetRecords())).subscribe((data:any)=>{
